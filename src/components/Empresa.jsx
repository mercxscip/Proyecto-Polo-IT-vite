    ...
    <div className='card-container p-2'>
        <div className="card h-100" style={{width:'18rem'}}>
            ...
            <div className="card-body">
                ...
                {props.pill && <button className='card-button'>{props.pill}</button>}
                {props.pill2 && <button>{props.pill2}</button>}
                <p className="card-text">{props.desc}</p>
                {props.redA && (
                <a  href={props.redA}>
                    <img className='btn-red' src={linkedin} alt="" style={{ width: "25px"}} />
                </a>
                )}
                {props.redB && (
                ...
                <a href={props.redF} className="btn btn-primary">
                    <img src={pinterest} alt="" style={{ width: "25px" }} />
                </a>
                )}
                {props.redG && (
                <a href={props.redG} className="btn btn-primary">
                    <img src={github} alt="" style={{ width: "25px" }} />
                </a>
                )}
                {props.redH && (
                <a href={props.redH} className="btn btn-primary">
                    <img src={dribbble} alt="" style={{ width: "25px" }} />
                </a>
                )}
                {props.redI && (
                <a href={props.redI} className="btn btn-primary">
                    <img src={figma} alt="" style={{ width: "25px" }} />
                </a>
                )}
                {props.redJ && (
                <a href={props.redJ} className="btn btn-primary">
                    <img src={twitch} alt="" style={{ width: "25px" }} />
                </a>
                )}
                {props.redK && (
                <a href={props.redK} className="btn btn-primary">
                    <img src={spotify} alt="" style={{ width: "25px" }} />
                </a>
                )}
                {props.redL && (
                <a href={props.redL} className="btn btn-primary">
                    <img src={podcast} alt="" style={{ width: "25px" }} />
                </a>
                )}
                {props.redM && (
                <a href={props.redM} className="btn btn-primary">
                    <img src={feedly} alt="" style={{ width: "25px" }} />
                </a>
                )}
                {props.redN && (
                <a href={props.redN} className="btn btn-primary">
                    <img src={blog} alt="" style={{ width: "25px" }} />
                </a>
                )}
                <button className='btn-contacto'>{props.contact}</button>
            </div>
        </div>
    </div>
    )
